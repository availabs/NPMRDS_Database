...
DROP PROCEDURE IF EXISTS _transcom_admin.update_transcom_event_administative_geographies();

CREATE OR REPLACE PROCEDURE _transcom_admin.update_transcom_event_administative_geographies()
  LANGUAGE plpgsql
  AS $$
    BEGIN
      ...
      RAISE NOTICE 'tmp_events_geoms count %', (SELECT COUNT(1) FROM tmp_events_geoms);
