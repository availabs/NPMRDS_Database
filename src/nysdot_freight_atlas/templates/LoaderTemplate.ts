...
export type NysdotFreightAtlas__LAYER_NAME_CAMEL_UPPER_CASE__LoaderParams = {
...
export default class NysdotFreightAtlas__LAYER_NAME_CAMEL_UPPER_CASE__Loader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "__LAYER_NAME_LOWER_SNAKE_CASE__",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
