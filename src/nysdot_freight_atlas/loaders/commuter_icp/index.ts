...
export type NysdotFreightAtlasCommuterIcpLoaderParams = {
...
export default class NysdotFreightAtlasCommuterIcpLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
