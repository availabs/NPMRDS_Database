...
export type NysdotFreightAtlasInterstateAnno4LoaderParams = {
...
export default class NysdotFreightAtlasInterstateAnno4Loader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "interstate_anno_4",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
