...
export type NysdotFreightAtlasCanadaLoaderParams = {
...
export default class NysdotFreightAtlasCanadaLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
