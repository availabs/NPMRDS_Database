...
export type NysdotFreightAtlasHighwaysLoaderParams = {
...
export default class NysdotFreightAtlasHighwaysLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
