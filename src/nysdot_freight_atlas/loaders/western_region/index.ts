...
export type NysdotFreightAtlasWesternRegionLoaderParams = {
...
export default class NysdotFreightAtlasWesternRegionLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "western_region",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
