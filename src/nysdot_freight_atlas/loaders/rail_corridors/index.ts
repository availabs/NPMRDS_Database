...
export type NysdotFreightAtlasRailCorridorsLoaderParams = {
...
export default class NysdotFreightAtlasRailCorridorsLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "rail_corridors",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
