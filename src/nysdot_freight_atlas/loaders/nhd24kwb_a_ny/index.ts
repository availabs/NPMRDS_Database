...
export type NysdotFreightAtlasNhd24KwbANyLoaderParams = {
...
export default class NysdotFreightAtlasNhd24KwbANyLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
