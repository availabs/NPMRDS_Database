...
export type NysdotFreightAtlasPipelineZonesLoaderParams = {
...
export default class NysdotFreightAtlasPipelineZonesLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "pipeline_zones",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
