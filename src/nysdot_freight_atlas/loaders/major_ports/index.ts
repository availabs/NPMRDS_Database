...
export type NysdotFreightAtlasMajorPortsLoaderParams = {
...
export default class NysdotFreightAtlasMajorPortsLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
