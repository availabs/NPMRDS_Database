...
export type NysdotFreightAtlasClass2LoaderParams = {
...
export default class NysdotFreightAtlasClass2Loader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
