...
export type NysdotFreightAtlasHighwayTrans2012LoaderParams = {
...
export default class NysdotFreightAtlasHighwayTrans2012Loader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "highway_trans_2012",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
