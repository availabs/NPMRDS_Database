...
export type NysdotFreightAtlasCountyLoaderParams = {
...
export default class NysdotFreightAtlasCountyLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
