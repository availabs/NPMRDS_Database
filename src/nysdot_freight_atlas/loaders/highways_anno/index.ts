...
export type NysdotFreightAtlasHighwaysAnnoLoaderParams = {
...
export default class NysdotFreightAtlasHighwaysAnnoLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
