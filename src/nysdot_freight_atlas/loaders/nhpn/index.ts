...
export type NysdotFreightAtlasNhpnLoaderParams = {
...
export default class NysdotFreightAtlasNhpnLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
