...
export type NysdotFreightAtlasCapitalRegionLoaderParams = {
...
export default class NysdotFreightAtlasCapitalRegionLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "capital_region",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
