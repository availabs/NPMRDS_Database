...
export type NysdotFreightAtlasClass3LoaderParams = {
...
export default class NysdotFreightAtlasClass3Loader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
