...
export type NysdotFreightAtlasWimDataLoaderParams = {
...
export default class NysdotFreightAtlasWimDataLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
