...
export type NysdotFreightAtlasMpoBoundariesLoaderParams = {
...
export default class NysdotFreightAtlasMpoBoundariesLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "mpo_boundaries",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
