...
export type NysdotFreightAtlasPipelinesLoaderParams = {
...
export default class NysdotFreightAtlasPipelinesLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
