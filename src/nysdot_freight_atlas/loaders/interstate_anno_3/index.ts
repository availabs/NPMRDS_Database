...
export type NysdotFreightAtlasInterstateAnno3LoaderParams = {
...
export default class NysdotFreightAtlasInterstateAnno3Loader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "interstate_anno_3",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
