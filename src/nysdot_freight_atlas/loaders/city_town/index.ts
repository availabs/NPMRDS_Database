...
export type NysdotFreightAtlasCityTownLoaderParams = {
...
export default class NysdotFreightAtlasCityTownLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
