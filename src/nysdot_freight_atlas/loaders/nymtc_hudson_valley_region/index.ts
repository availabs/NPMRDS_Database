...
export type NysdotFreightAtlasNymtcHudsonValleyRegionLoaderParams = {
...
export default class NysdotFreightAtlasNymtcHudsonValleyRegionLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "nymtc_hudson_valley_region",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
