...
export type NysdotFreightAtlasIntermodalFacilityLoaderParams = {
...
export default class NysdotFreightAtlasIntermodalFacilityLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "intermodal_facility",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
