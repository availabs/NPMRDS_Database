...
export type NysdotFreightAtlasBorderCounts2015LoaderParams = {
...
export default class NysdotFreightAtlasBorderCounts2015Loader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "border_counts_2015",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
