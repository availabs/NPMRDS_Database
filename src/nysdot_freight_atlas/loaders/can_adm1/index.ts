...
export type NysdotFreightAtlasCanAdm1LoaderParams = {
...
export default class NysdotFreightAtlasCanAdm1Loader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
