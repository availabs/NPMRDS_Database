...
export type NysdotFreightAtlasNysdotRegionsLoaderParams = {
...
export default class NysdotFreightAtlasNysdotRegionsLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "nysdot_regions",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
