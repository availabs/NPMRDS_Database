...
export type NysdotFreightAtlasTerminalsLoaderParams = {
...
export default class NysdotFreightAtlasTerminalsLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
