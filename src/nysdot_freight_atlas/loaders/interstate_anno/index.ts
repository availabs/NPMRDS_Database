...
export type NysdotFreightAtlasInterstateAnnoLoaderParams = {
...
export default class NysdotFreightAtlasInterstateAnnoLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "interstate_anno",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
