...
export type NysdotFreightAtlasInterstateLoaderParams = {
...
export default class NysdotFreightAtlasInterstateLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
