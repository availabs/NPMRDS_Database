...
export type NysdotFreightAtlasPipelineTerminalsLoaderParams = {
...
export default class NysdotFreightAtlasPipelineTerminalsLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "pipeline_terminals",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
