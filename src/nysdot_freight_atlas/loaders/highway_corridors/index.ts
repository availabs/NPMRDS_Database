...
export type NysdotFreightAtlasHighwayCorridorsLoaderParams = {
...
export default class NysdotFreightAtlasHighwayCorridorsLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "highway_corridors",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
