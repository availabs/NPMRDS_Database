...
export type NysdotFreightAtlasMpoCitiesLoaderParams = {
...
export default class NysdotFreightAtlasMpoCitiesLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
