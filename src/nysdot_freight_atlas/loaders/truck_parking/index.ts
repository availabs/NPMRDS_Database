...
export type NysdotFreightAtlasTruckParkingLoaderParams = {
...
export default class NysdotFreightAtlasTruckParkingLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
