...
export type NysdotFreightAtlasMpoCitiesResizesLoaderParams = {
...
export default class NysdotFreightAtlasMpoCitiesResizesLoader extends NysdotFreightAtlasLayerLoaderBaseClass {
  constructor({
    ...
    super({
      table_name_base: "mpo_cities_resizes",
      nysdot_freight_atlas_geodatabase_path,
      table_version,
      geodatabase_layer_name,
      pg_env,
