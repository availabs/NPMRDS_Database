...
INSERT INTO us.mpo_populations (
  ...
  ('Poughkeepsie-Dutchess County Transportation Council','PDCTC','NY','Poughkeepsie',824,297508,1982),
  ...
  ('Watertown-Jefferson County Transportation Council','WJCATC','NY','Watertown',125,66322,2014)
;
