...
DROP MATERIALIZED VIEW IF EXISTS public.pm3_authoritative_view;

CREATE MATERIALIZED VIEW public.pm3_authoritative_view
  WITH (fillfactor=100)
  AS 
    SELECT
...
ANALYZE public.pm3_authoritative_view;
