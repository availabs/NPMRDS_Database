...
DROP TABLE IF EXISTS "__STATE__".nprm7_time_dist___YEAR_MONTH_SUBSET__ CASCADE;

CREATE TABLE "__STATE__".nprm7_time_dist___YEAR_MONTH_SUBSET__ (
  LIKE "__STATE__".nprm7_time_dist INCLUDING ALL
);


INSERT INTO "__STATE__".nprm7_time_dist___YEAR_MONTH_SUBSET__ 
  ...
  SELECT tmc, 
    ...
    FROM (
      ...
      FROM  (
        ...
        WHERE (npmrds.state = '__STATE__')
          AND ((date >= DATE '__START_DATE__') AND (date < '__END_DATE__')) -- Need the symmetry with the CHECK.
...
ALTER TABLE "__STATE__".nprm7_time_dist___YEAR_MONTH_SUBSET__
...
CREATE UNIQUE INDEX nprm7_time_dist___YEAR_MONTH_SUBSET___idx
  ON "__STATE__".nprm7_time_dist___YEAR_MONTH_SUBSET__ (tmc)
  WITH (fillfactor = 100);

ALTER TABLE "__STATE__".nprm7_time_dist___YEAR_MONTH_SUBSET__
  ADD CONSTRAINT nprm7_time_dist___YEAR_MONTH_SUBSET___pkey
    PRIMARY KEY USING INDEX nprm7_time_dist___YEAR_MONTH_SUBSET___idx;


CLUSTER VERBOSE "__STATE__".nprm7_time_dist___YEAR_MONTH_SUBSET__
  USING nprm7_time_dist___YEAR_MONTH_SUBSET___pkey;

ANALYZE VERBOSE "__STATE__".nprm7_time_dist___YEAR_MONTH_SUBSET__;
